    ...
    this.connection.listen(function(message) {
      ...
      switch (action) {
        ...
        /*case Types.Messages.CS_BANKSTORE:
          //console.info("Player: " + self.player.name + " bank store: " + message[0]);
          self.handleBankStore(message);
          break;
        case Types.Messages.CS_BANKRETRIEVE:
          //console.info("Player: " + self.player.name + " bank retrieve: " + message[0]);
...
// TODO - Fix CHaracter Info
        ...
        case Types.Messages.CS_QUEST:
          ...
          break;
        //case Types.Messages.CS_SEND_INVENTORY:
          //self.handleSendInventory(message);
          //break;
