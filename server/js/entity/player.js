...
// TODO - Fill db_player variable assignments.
    sendPlayer: function(db_player)
    {
        ...
        DBH.getItems(self, 1, function(bItems) {
              ...
              self.itemStore[1] = self.bank;
        DBH.getItems(self, 0, function(iItems) {
              self.inventory = new Inventory(self, 48, iItems);
              self.itemStore[0] = self.inventory;
        DBH.loadAchievements(self, function (achievements) {
          DBH.loadQuests(self, function(quests) {
            console.info("loaded quest");
